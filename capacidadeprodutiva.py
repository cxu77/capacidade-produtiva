...
gb.configure_column(field = 'Linhas',  rowDrag = True, rowDragManaged = True, sortable = True)
#gb.configure_auto_height()
go = gb.build()  
results = AgGrid(data = cal, reload_data = False, gridOptions = go, enable_enterprise_modules=True, sortable = True, update_mode = GridUpdateMode.VALUE_CHANGED, data_return_mode = DataReturnMode.AS_INPUT)
dict={}
...
#go = gb.build()
AgGrid(result_agregado, enable_enterprise_modules=True)    
